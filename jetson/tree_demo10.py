...
diff: allows us to see motor controll
"""
        ...
        while True:
            ...
            if prompt_data is not None:
                try:
                    ...
                    # Color the detections based on target/obstacle
                    for detection in tree_output.detections:
                        if detection.id != 0:  # Skip image-level detections
                            detection.color = (0, 0, 255) if detection.labels[0] == prompt_data['target'] else (255, 0, 0)
